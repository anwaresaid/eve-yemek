                    ...
                    <form onSubmit = {formik.handleSubmit} >
                        <div className="p-grid">
                            ...
                            <FormColumn divideCount={3}>
                                ...
                                <InputGroup>
                                    <InputContainer label={i18n.t('vegetablesOnly')} name="is_vegi" formiks={inputFormiks} noAutoCol12 component={InputSwitch} iprops={{
                                        value:formik.values.is_vegi,
                                        checked:formik.values.is_vegi,
                                        onChange:formik.handleChange
                                    }}/>
                                    
                                    <InputContainer label={i18n.t('prioritized')} name="featured" formiks={inputFormiks} noAutoCol12 component={InputSwitch} iprops={{
                                        value:formik.values.featured,
                                        checked:formik.values.featured,
                                        onChange:formik.handleChange
                                    }}/>
                                    
                                    <InputContainer label={i18n.t('open')} name="active" formiks={inputFormiks} noAutoCol12 component={InputSwitch} iprops={{
