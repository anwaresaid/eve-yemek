export const translations = {
  ...
  restaurantList: 'Список ресторанов',
  createRestaurant: 'Создать ресторан',
  meals: 'Еда',
  mealList: 'Список блюд',
  createMeal: 'Создать блюдo',
  mealCategories: 'Категории блюд',
  categoryList: 'Список категорий',
  createMealCategory: 'Создать категорию еды',
  ...
  ordersFromTheLast7Days: 'Заказы за последние 7 дней',
  ...
  restaurantFee: 'Ресторанный сбор',
  ...
  taxApplicable: 'Применимо к налогу',
  taxPercentage: 'Налоговый процент',
  deliveryFeeApplicable: 'Плата за доставку применима',
  ...
  googleMaps: 'Карты Google',

  paymentGateway: 'Платежный шлюз',

  // Inputs
  isRequired: '{{input}} требуется',
