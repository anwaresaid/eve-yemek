...
const TopBar = (props:IProps) => {
    ...
    const toggleProfile = () =>{
        ...
        const toggleOverFlow= document.querySelector('.overFlow');
        toggleProfile.classList.toggle('active');
        toggleOverFlow.classList.toggle('active');
    }
    ...
    return (
        <>
            <Card  id='main_context_card'className={"main-context-card" + (props.hideBar  ? "-showBar" : "-hideBar")} >
                ...
                <div className='overFlow' onClick={toggleProfile}></div>
