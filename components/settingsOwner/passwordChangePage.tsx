...
const PasswordChangePage = () => {
    ...
    const formik = useFormik({
        ...
        validate: (data) => {
            ...
            if (!data.password) {
                errors.password = i18n.t("isRequired", {
                    input: i18n.t("password"),
                });
            }

            if (!data.new_password) {
                errors.new_password = i18n.t("isRequired", {
                    input: i18n.t("newPassword"),
                });
            }

            if (!data.new_password_again) {
                errors.new_password_again = i18n.t("isRequired", {
                    input: i18n.t("newPasswordAgain"),
                });
            }
    ...
    useEffect(() => {
        if (changePasswordStatus?.error) {
            toast.current.show({
                ...
                detail:
                    changePasswordStatus?.error || i18n.t("anErrorOccurred"),
            });
        }
